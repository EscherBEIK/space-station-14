...
using Content.Shared._FtC.CCVars;
...
public sealed partial class DogVisionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        Subs.CVar(_cfg, _FtCCCvars.NoVisionFilters, OnNoVisionFiltersChanged);
    ...
    {
        if (uid == _playerMan.LocalEntity && !_cfg.GetCVar(_FtCCCvars.NoVisionFilters))
    ...
    {
        if (!_cfg.GetCVar(_FtCCCvars.NoVisionFilters))
            _overlayMan.AddOverlay(_overlay);
    }
