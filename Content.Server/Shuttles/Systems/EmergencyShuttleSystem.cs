...
public sealed partial class EmergencyShuttleSystem : EntitySystem
{
    ...
    [Dependency] private readonly Content.Server._FtC.Arrivals.CentcommSystem _centcommSystem = default!;
    ...
    public void AnnounceShuttleDock(ShuttleDockResult result, bool extended)
    {
        ...
        _centcommSystem.EnableFtl(_centcommSystem.CentComMapUid); // _FtC: centcom
    }
...
// start-_FtC: centcom
    ...
    {
        var centcom = EntityManager.System<Content.Server._FtC.Arrivals.CentcommSystem>();
