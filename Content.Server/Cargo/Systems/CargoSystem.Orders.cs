    ...
    public sealed partial class CargoSystem
    {
        ...
        private void UpdateConsole(float frameTime)
        {
            ...
            while (_timer > Delay)
            {
                ...
                var stationQuery = EntityQueryEnumerator<StationBankAccountComponent>(); // FtC-StockTrading: Early merge #33123
                while (stationQuery.MoveNext(out var uid, out var bank)) // FtC-StockTrading: Early merge #33123
                {
        ...
        private void OnApproveOrderMessage(EntityUid uid, CargoOrderConsoleComponent component, CargoConsoleApproveOrderMessage args)
        {
            ...
            orderDatabase.Orders.Remove(order);
             UpdateBankAccount(station.Value, bank, -cost); // FtC-StockTrading: Early merge #33123
