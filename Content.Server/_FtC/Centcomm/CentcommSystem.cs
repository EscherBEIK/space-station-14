...
using Content.Shared._FtC.Abilities;
using Content.Shared._FtC.Arrivals;
...
namespace Content.Server._FtC.Arrivals;
...
public sealed class CentcommSystem : EntitySystem
{
    ...
    public void EnsureCentcom(bool force = false)
    {
        ...
        var ent = _gameTicker.LoadGameMap(
            ...
            {
                LoadMap = false
            }, "АКН Трурль").FirstOrNull(HasComp<BecomesStationComponent>);
